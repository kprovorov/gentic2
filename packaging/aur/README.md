...
This directory maintains the [`gentic2-bin`](https://aur.archlinux.org/packages/gentic2-bin) and
[`gentic2-nightly-bin`](https://aur.archlinux.org/packages/gentic2-nightly-bin) packages. Both

...
import { RelayManagedEndpoint } from "@gentic2/contracts/relay";
...
export class RemoteDpopAccessToken extends Schema.Class<RemoteDpopAccessToken>(
  "@gentic2/client-runtime/authorization/RemoteDpopAccessToken",
)({
...
>()("@gentic2/client-runtime/authorization/tokenStore/RemoteDpopAccessTokenStore") {}

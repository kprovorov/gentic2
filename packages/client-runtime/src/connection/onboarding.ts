import type { DesktopSshEnvironmentTarget, EnvironmentId } from "@gentic2/contracts";
import { resolveRemotePairingTarget } from "@gentic2/shared/remote";
...
>()("@gentic2/client-runtime/connection/onboarding/ConnectionOnboarding") {}

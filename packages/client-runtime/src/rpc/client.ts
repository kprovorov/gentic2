import { ORCHESTRATION_WS_METHODS, WS_METHODS } from "@gentic2/contracts";
...
}>("@gentic2/client-runtime/rpc/EnvironmentRpcRequestObserver", {
  defaultValue: () => ({
...
}>("@gentic2/client-runtime/rpc/EnvironmentRpcSubscriptionObserver", {
  defaultValue: () => ({
    observe: () => Effect.succeed(Effect.void),
  }),
}) {}

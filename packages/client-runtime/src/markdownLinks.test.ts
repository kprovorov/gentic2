...
describe("parseFileUrlHref", () => {
  it.each([
    ...
    [
      "file:///D:/Programme/gentic2/OpenInPicker.tsx#L69",
      "D:/Programme/gentic2/OpenInPicker.tsx",
      "#L69",
    ],
...
describe("parseMarkdownFileLink", () => {
  ...
  it.each([
    ...
    ["\\\\server\\share\\image.png", "\\\\server\\share\\image.png"],
    ["/D:/Programme/gentic2/OpenInPicker.tsx", "D:/Programme/gentic2/OpenInPicker.tsx"],
    ["</D:/Programme/gentic2/ChatMarkdown.tsx:1>", "D:/Programme/gentic2/ChatMarkdown.tsx"],
...
describe("workspaceRelativeFilePath", () => {
  it.each([
    ...
    ["/repo/project/src/main.ts", "/repo/project/", "src/main.ts"],
    ["C:\\Users\\mike\\gentic2\\apps\\web\\a.ts", "C:/Users/mike/gentic2", "apps/web/a.ts"],
    ["/C:/Users/mike/gentic2/apps/web/a.ts", "C:/Users/mike/gentic2", "apps/web/a.ts"],
    ...
    ["C:/USERS/mike/gentic2/main.ts", "c:/users/MIKE/gentic2", "main.ts"],
    ["/C:/USERS/mike/gentic2/main.ts", "/c:/users/MIKE/gentic2", "main.ts"],

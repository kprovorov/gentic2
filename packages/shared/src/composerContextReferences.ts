...
/**
 * Canonical inline reference: `[label](g2-context://v1/<kind>/<contextId>)`, or the image
...
const CONTEXT_PROTOCOL = "g2-context:";
...
export function collectComposerContextReferences(
  ...
  if (!text.includes("](g2-context:")) return occurrences;
...
const CONTEXT_ENVELOPE_TAG = "g2_context";
...
/**
 * Captured text is data. A terminal line or PR comment that contains `</g2_context>` or

...
import { G2ProjectFile } from "./g2ProjectFile.ts";

const decode = Schema.decodeUnknownSync(G2ProjectFile);

describe("G2ProjectFile", () => {
  it("decodes a full project file", () => {
    const decoded = decode({
      $schema: "https://gentic2.com/schema/g2.json",

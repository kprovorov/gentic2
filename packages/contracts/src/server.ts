...
/**
 * A palette the environment's machine publishes for Gentic2 to follow, read
 ...
 * over as a coherent Gentic2 palette instead of a foreign one.
 */
...
export const ServerSelfUpdateInput = Schema.Struct({
  /** Exact npm version of the `g2` package to install (never a dist-tag, so

...
}).annotate({ description: "Links an authenticated cloud user to a G2 environment." });
...
>()("@gentic2/contracts/relay/RelayClientPrincipal") {}
...
>()("@gentic2/contracts/relay/RelayEnvironmentPrincipal") {}

const RelayClientBearerAuthorization = HttpApiSecurity.http({ scheme: "bearer" }).pipe(
  HttpApiSecurity.annotate(
    OpenApi.Description,
    "Clerk session or OAuth bearer token for the signed-in Gentic2 Connect user.",
  ),
);
...
export const RelayPublicClientId = Schema.Literals(["g2-mobile", "g2-web"]);
export type RelayPublicClientId = typeof RelayPublicClientId.Type;
export const RelayMobileClientId = "g2-mobile" as const;
export const RelayWebClientId = "g2-web" as const;
...
export const RelayApi = HttpApi.make("RelayApi")
  ...
  .annotate(OpenApi.Title, "Gentic2 Relay API")
  .annotate(OpenApi.Version, "1.0.0")
  .annotate(
    OpenApi.Description,
    "Control-plane API for linking G2 environments, connecting authorized clients, and publishing agent activity.",
  );

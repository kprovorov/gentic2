...
describe("TerminalOpenInput", () => {
  ...
  it("accepts optional env overrides", () => {
    const parsed = decodeSync(TerminalOpenInput, {
      ...
      terminalId: DEFAULT_TERMINAL_ID,
      cwd: "/tmp/project",
      worktreePath: "/tmp/project/.g2/worktrees/feature-a",
      cols: 100,
      rows: 24,
      env: {
        GENTIC2_PROJECT_ROOT: "/tmp/project",
        CUSTOM_FLAG: "1",
      },
      providerInstanceId: "codex_work",
    });
    ...
    expect(parsed.worktreePath).toBe("/tmp/project/.g2/worktrees/feature-a");
    ...
    expect(
      decodes(TerminalEvent, {
        ...
        snapshot: {
          threadId: "thread-1",
          terminalId: DEFAULT_TERMINAL_ID,
          cwd: "/tmp/project/.g2/worktrees/feature-a",
          worktreePath: "/tmp/project/.g2/worktrees/feature-a",
          status: "running",
          pid: 1234,
          history: "",

 ...
 * machine into a Gentic2 browser profile.
 *
...
export const BrowserImportInput = Schema.Struct({
  ...
  /** Gentic2 profile the cookies are written into. */
...
const BROWSER_IMPORT_UNAVAILABLE_COPY: Readonly<Record<BrowserImportUnavailableReason, string>> = {
  ...
  needsFullDiskAccess:
    "Give Gentic2 Full Disk Access in System Settings → Privacy & Security, then retry.",

...
const rule = createOxlintRuleHarness("gentic2/no-native-title-tooltip", {
  filename: "fixture.tsx",
});

describe("gentic2/no-native-title-tooltip", () => {
  rule.valid(
  ...
  rule.valid("allows document.title assignments", `document.title = "Thread · Gentic2";`);

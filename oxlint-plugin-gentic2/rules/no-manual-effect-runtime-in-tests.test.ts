...
const rule = createOxlintRuleHarness("gentic2/no-manual-effect-runtime-in-tests", {
  filename: "fixture.test.ts",
});

describe("gentic2/no-manual-effect-runtime-in-tests", () => {
  rule.valid(
...
const productionRule = createOxlintRuleHarness("gentic2/no-manual-effect-runtime-in-tests");
...
const legacyRule = createOxlintRuleHarness("gentic2/no-manual-effect-runtime-in-tests", {
  filename: "legacy.test.ts",
  ruleOptions: [{ maxOccurrences: 2 }],
});

describe("gentic2/no-manual-effect-runtime-in-tests with maxOccurrences", () => {
  legacyRule.valid(

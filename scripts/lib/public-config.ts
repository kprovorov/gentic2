...
export interface Gentic2PublicConfig {
...
export function loadRepoEnv({
  ...
  return {
    ...
    ...(config.clerkPublishableKey
      ? {
          GENTIC2_CLERK_PUBLISHABLE_KEY: config.clerkPublishableKey,
    ...
    ...(config.clerkJwtTemplate
      ? {
          GENTIC2_CLERK_JWT_TEMPLATE: config.clerkJwtTemplate,
...
export function resolvePublicConfig(...sources: readonly Environment[]): Gentic2PublicConfig {
  return {

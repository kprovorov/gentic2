  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new Gentic2 prerelease is available for nightly testers."
          : "A new Gentic2 latest release is available.",
...
).pipe(Command.withDescription("Post a Gentic2 release announcement to Discord."));

...
Item {
    ...
    // A cached, bounded PNG is shared by each output. Nothing repaints while waiting for G2.
    Image {
        id: snapshot
        visible: false
    ...
    DBusCall {
        id: next
        service: root.bus
        path: "/com/gentic2/KdeCapture/Feedback"
        dbusInterface: "com.gentic2.KdeCapture.Feedback"
        method: "Next"

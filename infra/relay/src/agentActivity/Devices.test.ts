import type { RelayDeviceRegistrationRequest } from "@gentic2/contracts/relay";
...
const registration: RelayDeviceRegistrationRequest = {
  ...
  bundleId: "com.gentic2.gentic2.preview" as RelayDeviceRegistrationRequest["bundleId"],

...
import { encodeOAuthScope, parseAllowedOAuthScope } from "@gentic2/shared/oauthScope";
import {
...
const LINK_CHALLENGE_TYP = "g2-link-challenge+jwt";
const ACCESS_TOKEN_TYP = "g2-relay-dpop-access+jwt";
...
>()("gentic2-relay/auth/RelayTokens") {}

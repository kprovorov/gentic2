...
>()("@gentic2/desktop/shell/DesktopShellEnvironment") {}
...
const startMarker = (name: string) => `__GENTIC2_ENV_${name}_START__`;
const endMarker = (name: string) => `__GENTIC2_ENV_${name}_END__`;

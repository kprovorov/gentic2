...
const PREVIEW_PARTITION_PREFIX = "persist:gentic2-preview-";
/**
 ...
 */
const PREVIEW_EPHEMERAL_PARTITION_PREFIX = "gentic2-preview-ephemeral-";
...
>()("@gentic2/desktop/preview/BrowserSession") {}

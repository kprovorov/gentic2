 ...
 * into a Gentic2 browser profile's Electron partition.
 *
...
import { BrowserImportFailureReason } from "@gentic2/contracts";
...
import { HostProcessExecutablePath, HostProcessPlatform } from "@gentic2/shared/hostProcess";
...
>()("@gentic2/desktop/preview/BrowserImport/BrowserImport") {}

...
import type { RemoteG2RunnerOptions } from "@gentic2/ssh/tunnel";
...
): RemoteG2RunnerOptions => {
  const devRemoteEntryPath = Option.getOrUndefined(environment.devRemoteG2ServerEntryPath);

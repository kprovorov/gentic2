...
<header>↑ Drag Gentic2 into the list above</header>
<button id="app" draggable="true" aria-label="Drag Gentic2 to System Settings, or click to reveal in Finder"><img src="${escapeHtml(icon)}" alt="" draggable="false">Gentic2</button>
</main></body></html>`;
}
...
export class MacPermissionHelper {
  ...
  async show(
    ...
    if (!appIcon) throw new Error("The packaged Gentic2 icon is missing.");

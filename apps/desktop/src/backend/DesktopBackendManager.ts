...
import { waitForHttpReady as waitForHttpReadyShared } from "@gentic2/shared/httpReadiness";
...
const BACKEND_READINESS_PATH = "/.well-known/g2/environment";
...
export interface DesktopBackendStartConfig extends BackendProcessContext {
  ...
  // GENTIC2_HOME can't pin the WSL backend to /mnt/c/...\.g2.

import { createAdvertisedEndpoint } from "@gentic2/shared/advertisedEndpoint";
import type { AdvertisedEndpoint, AdvertisedEndpointProvider } from "@gentic2/contracts";
import {
...
export { parseTailscaleMagicDnsName } from "@gentic2/tailscale";

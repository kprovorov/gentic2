import type { DesktopSshPasswordPromptRequest } from "@gentic2/contracts";
import { DesktopSshPasswordPromptResolutionInputSchema } from "@gentic2/contracts";
import type { SshPasswordRequest } from "@gentic2/ssh/auth";
...
export class DesktopSshPromptWindowUnavailableError extends Schema.TaggedError<DesktopSshPromptWindowUnavailableError>()(
  ...
  override get message(): string {
    ...
    return `Gentic2 window is unavailable during ${this.stage} for SSH authentication to ${this.destination} (request: ${request}).`;
  }
}
...
>()("@gentic2/desktop/ssh/DesktopSshPasswordPrompts") {}

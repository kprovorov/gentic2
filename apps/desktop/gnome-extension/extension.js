...
const NAME = "org.gnome.Shell.Extensions.G2SnapShot";
const PATH = "/org/gnome/Shell/Extensions/G2SnapShot";
...
function takeSnapshot(animate) {
  ...
  if (animate && St.Settings.get().enable_animations) {
    try {
      ...
      console.warn(`G2 capture preview unavailable: ${error.message}`);
    }
  }
...
export default class G2SnapShotExtension extends Extension {
  enable() {

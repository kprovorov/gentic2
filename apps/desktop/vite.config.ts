...
const shouldLaunchElectronAfterPack = process.env.GENTIC2_DESKTOP_DEV === "1";
...
export default defineConfig({
  run: {
    tasks: {
      ...
      dev: {
        command:
          "node scripts/build-browser-secret.mjs && node scripts/build-preview-annotation-css.mjs && cross-env GENTIC2_DESKTOP_DEV=1 vp pack --watch",
        dependsOn: ["g2#build"],
        cache: false,
      },
      "dev:bundle": {

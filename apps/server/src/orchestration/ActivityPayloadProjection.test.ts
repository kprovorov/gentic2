...
import type { OrchestrationThreadActivity } from "@gentic2/contracts";
...
describe("projectActivityPayload", () => {
  ...
  it.each([
    ...
    {
      toolName: "mcp__gentic2__preview_navigate",
      result: { content: '{"url":"https://example.com/"}' },
    },
    { tool: "gentic2_preview_status", state: { output: '{"url":"https://example.com/"}' } },
    {
      toolName: "mcp__gentic2__preview_snapshot",
      result: {
        content: [
    ...
    ...[
      ...
      toolName: `mcp__gentic2__preview_${action}`,
      result: { content: '{"toolIcon":{"_tag":"website","pageUrl":"https://example.com/"}}' },
    })),
  ...
  it.each([
    ...
    {
      toolName: "mcp__gentic2__preview_evaluate",
      result: { content: '{"url":"https://example.com/"}' },
    },
    {
      toolName: "mcp__gentic2__preview_open",
      result: { isError: true, content: '{"url":"https://example.com/"}' },
    },
    { toolName: "mcp__gentic2__preview_open", result: { content: "malformed JSON" } },
    { toolName: "mcp__gentic2__preview_open", result: { content: '{"url":"about:blank"}' } },

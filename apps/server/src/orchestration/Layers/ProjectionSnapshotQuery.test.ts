    ...
    Effect.gen(function* () {
      ...
      yield* sql`
        ...
        VALUES
          (
            ...
            'kprovorov/gentic2',
            41,
            'https://github.com/kprovorov/gentic2/pull/41',
            'created',
      ...
      yield* sql`
        ...
        VALUES (
          ...
          NULL,
          NULL,
          '{"projectId":"project-1","repository":"kprovorov/gentic2","number":41,"url":"https://github.com/kprovorov/gentic2/pull/41"}',
      ...
      const expectedPullRequests: ReadonlyArray<ThreadPullRequestLink> = [
        {
          ...
          repository: "kprovorov/gentic2",
          number: 41,
          url: "https://github.com/kprovorov/gentic2/pull/41",
          source: "created",

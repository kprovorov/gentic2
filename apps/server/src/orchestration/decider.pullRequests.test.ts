  ...
  it.effect("links the same Forgejo number on two ports and unlinks an older portless record", () =>
    Effect.gen(function* () {
      ...
      const command = yield* decodeCommand({
        ...
        repository: "kprovorov/gentic2",
        number: 42,
        url: "http://forge.example:4000/kprovorov/gentic2/pulls/42",
        source: "manual",
      });
  ...
  it.effect("legacy unlink cannot remove a newer cross-host link", () =>
    Effect.gen(function* () {
      ...
      const foreign = makeLink({
        ...
        url: "https://github.enterprise.test/kprovorov/gentic2/pull/42",
    ...
    Effect.gen(function* () {
      ...
      const command = yield* decodeCommand({
        ...
        linkedPullRequest: {
          ...
          repository: "kprovorov/gentic2",
          number: 99,
          url: "https://github.com/kprovorov/gentic2/pull/99",
        },
      });

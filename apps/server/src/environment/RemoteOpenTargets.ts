 ...
 */
import { type RemoteOpenTarget } from "@gentic2/contracts";
import { HostProcessHostname } from "@gentic2/shared/hostProcess";
import * as NetService from "@gentic2/shared/Net";
import { readTailscaleStatus } from "@gentic2/tailscale";
...
>()("g2/environment/RemoteOpenTargets") {}

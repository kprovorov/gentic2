import { KeybindingCommand, KeybindingRule, KeybindingsConfig } from "@gentic2/contracts";
...
import { KeybindingsConfigError } from "@gentic2/contracts";
    ...
    Layer.provideMerge(
      Layer.fresh(
        ServerConfig.layerTest(process.cwd(), {
          prefix: "gentic2-keybindings-test-",
        }),
      ),
    ),
  );

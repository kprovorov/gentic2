...
import { isDevProxiedPath } from "@gentic2/shared/devProxy";
import { decodeOtlpTraceRecords } from "@gentic2/shared/observability";
...
const DESKTOP_RENDERER_ORIGINS = ["gentic2://app", "gentic2-dev://app"];
...
export const browserApiCorsLayer = Layer.unwrap(
  Effect.gen(function* () {
    ...
    //
    // GENTIC2_DEV_ALLOWED_ORIGINS covers dev servers reached from a second

...
const TEST_ENV = {
  GENTIC2_CLERK_PUBLISHABLE_KEY: "pk_test_Y2xlcmsuZXhhbXBsZS50ZXN0JA==",
  GENTIC2_CLERK_CLI_OAUTH_CLIENT_ID: "oauth_client_test",
  GENTIC2_HOSTED_APP_URL: "https://hosted.example.test",
};

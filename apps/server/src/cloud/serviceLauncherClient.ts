import type { ServerSelfUpdateOutcome } from "@gentic2/contracts";
  ...
  override get message(): string {
    switch (this.operation) {
      ...
      case "version-mismatch":
        return "The service launcher started a different g2 version.";
...
export const ServiceLauncherHostProcess = Context.Reference<ServiceLauncherProcess>(
  "g2/cloud/serviceLauncherHostProcess",
  {
    defaultValue: () => ({
...
>()("g2/cloud/serviceLauncherClient") {}

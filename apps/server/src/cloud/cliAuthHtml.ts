...
declare const __GENTIC2_BUILD_CHANNEL__: "nightly" | "latest" | undefined;

function resolveLoopbackAuthorizationStage(): LoopbackAuthorizationStage {
  return typeof __GENTIC2_BUILD_CHANNEL__ === "undefined" ? "dev" : __GENTIC2_BUILD_CHANNEL__;
}

const stageBrands = {
  dev: "Gentic2 (Dev)",
  nightly: "Gentic2 (Nightly)",
  latest: "Gentic2",
...
<html lang="en">
  <head>
    ...
    <title>Gentic2 Connect authorization complete</title>
    <style>
      :root {
  ...
  <body>
    <main>
      ...
      <section class="content">
        ...
        <p class="description">Return to your terminal to finish setting up Gentic2 Connect. You can close this window.</p>
      </section>
    </main>
  </body>
</html>`;

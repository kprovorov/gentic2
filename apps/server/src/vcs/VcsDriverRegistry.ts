...
import type { VcsDriverKind, VcsError, VcsRepositoryIdentity } from "@gentic2/contracts";
import { VcsUnsupportedOperationError } from "@gentic2/contracts";

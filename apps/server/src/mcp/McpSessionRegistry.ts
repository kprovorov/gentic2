import { ProviderInstanceId, ThreadId } from "@gentic2/contracts";
 ...
 * the only thing guarding the `gentic2` toolkits on a remote-reachable server.
 */

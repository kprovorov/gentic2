...
import { EnvironmentId, PreviewTabId, ProviderInstanceId, ThreadId } from "@gentic2/contracts";
...
const TestLayer = McpHttpServer.PreviewToolkitRegistrationLive.pipe(
  ...
  Layer.provideMerge(ServerConfig.layerTest(process.cwd(), { prefix: "g2-mcp-http-server-test-" })),

          ...
          ...(mcpSession
            ? {
                environment: {
                  ...
                  G2_MCP_BEARER_TOKEN: mcpSession.authorizationHeader.replace(/^Bearer\s+/, ""),
                },
                appServerArgs: [
                  "-c",
                  `mcp_servers.gentic2.url=${mcpSession.endpoint}`,
                  "-c",
                  'mcp_servers.gentic2.bearer_token_env_var="G2_MCP_BEARER_TOKEN"',
                ],

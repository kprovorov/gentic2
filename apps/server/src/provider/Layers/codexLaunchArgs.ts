import { tokenizeCliArgs } from "@gentic2/shared/cliArgs";

const GENTIC2_CODEX_LAUNCH_ARGS_ENV = "GENTIC2_CODEX_LAUNCH_ARGS";

export const resolveCodexLaunchArgs = (
  launchArgs?: string,
  environment: NodeJS.ProcessEnv = process.env,
) => environment[GENTIC2_CODEX_LAUNCH_ARGS_ENV]?.trim() || launchArgs?.trim() || "";

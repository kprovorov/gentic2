...
import { ProviderInstanceId, ProviderSetupError, type ProviderAuthState } from "@gentic2/contracts";
...
const owner = "g2-auth-session-owner";
const otherOwner = "g2-auth-session-other";

import { type GrokSettings, ProviderDriverKind, type RuntimeMode } from "@gentic2/contracts";
...
const GENTIC2_OAUTH_REFERRER = "gentic2";
...
export function buildGrokAcpSpawnInput(
  ...
  return {
    ...
    env: {
      ...environment,
      [GROK_OAUTH2_REFERRER_ENV]: GENTIC2_OAUTH_REFERRER,
    },
  };
}
...
/**
 * G2's built-in Grok slug. It is the CLI's product name, not a model id the ACP accepts,

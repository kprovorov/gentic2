...
import { projectThreadAwareness } from "@gentic2/shared/agentAwareness";
      ...
      switch (startupState) {
        case "waiting-for-link":
          yield* Effect.logInfo(
            "agent activity publishing standby; waiting for Gentic2 Connect link reconciliation",
          );
          break;
        case "disabled":
          yield* Effect.logInfo(
            "agent activity publishing disabled by Gentic2 Connect configuration",
          );
          break;
        case "enabled":

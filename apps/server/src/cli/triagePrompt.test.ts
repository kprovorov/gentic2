...
it("launch prompt stays a single argv-safe line naming the prompt file", () => {
  ...
  const launch = buildTriageLaunchPrompt(String.raw`C:\Users\a b\.g2\userdata\triage\x\prompt.md`);
  assert.notInclude(launch, "\n");
  assert.include(launch, String.raw`C:\Users\a b\.g2\userdata\triage\x\prompt.md`);
...
it("context file carries every path the playbook depends on", () => {
  const context = buildTriageContext({
    ...
    os: "linux x64 (7.0.0)",
    nodeVersion: "v24.0.0",
    launchedAs: "npx g2 triage",
    server: "running (pid 42, http://127.0.0.1:4501)",
    paths: {
      stateDir: "/home/u/.g2/userdata",
      dbPath: "/home/u/.g2/userdata/state.sqlite",
      settingsPath: "/home/u/.g2/userdata/settings.json",
      logsDir: "/home/u/.g2/userdata/logs",
      serverLogPath: "/home/u/.g2/userdata/logs/server.log",
      serverTracePath: "/home/u/.g2/userdata/logs/server.trace.ndjson",
      providerEventLogPath: "/home/u/.g2/userdata/logs/provider/events.log",
      terminalLogsDir: "/home/u/.g2/userdata/logs/terminals",
      providerStatusCacheDir: "/home/u/.g2/caches",
      secretsDir: "/home/u/.g2/userdata/secrets",
      sourceCacheDir: "/home/u/.g2/source",
    },
  });
  assert.include(context, "/home/u/.g2/userdata/state.sqlite");
  assert.include(context, "/home/u/.g2/userdata/logs/server.trace.ndjson");
  assert.include(context, "/home/u/.g2/userdata/logs/provider/events.log");
  assert.include(context, "/home/u/.g2/userdata/secrets");
  assert.include(context, "/home/u/.g2/source");
  assert.include(context, "npx g2 triage");

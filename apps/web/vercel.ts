...
const ROUTER_HOST = "app.gentic2.com";
const HOSTED_WEB_CHANNEL_COOKIE = "gentic2_web_channel";
const LATEST_ORIGIN = "https://latest.app.gentic2.com";
const NIGHTLY_ORIGIN = "https://nightly.app.gentic2.com";
...
export const config: VercelConfig = {
  buildCommand:
    'vp run --filter @gentic2/web build && node ../../scripts/apply-web-brand-assets.ts --channel "${VITE_HOSTED_APP_CHANNEL:-latest}"',
  git: {
    deploymentEnabled: false,
  },
  installCommand:
    "npm install -g vite-plus && vp install --ignore-scripts --filter '@gentic2/scripts...' --filter '@gentic2/web...'",
  routes: [
    {
      src: "/__gentic2/channel",

...
import { resolveEnvironmentMachineKind, type ScopedProjectRef } from "@gentic2/contracts";
import { scopedProjectKey, scopeProjectRef } from "@gentic2/client-runtime/environment";

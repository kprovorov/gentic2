...
import type { AssistantCitation, MessageId, ScopedThreadRef } from "@gentic2/contracts";
...
const COMMENT_HIGHLIGHT_NAME = "g2-assistant-citation-comment";
...
export function observeAssistantCitationSource({
  ...
  const clear = () => {
    if (highlighted && CSS.highlights.get("g2-assistant-citation") === highlighted) {
      CSS.highlights.delete("g2-assistant-citation");
    }
    highlighted = null;
    ownedRange = null;
  ...
  const highlight = () => {
    ...
    if (typeof Highlight !== "undefined" && typeof CSS !== "undefined" && CSS.highlights) {
      ...
      CSS.highlights.set("g2-assistant-citation", highlighted);
      ownedRange = range;
    ...
    if (!pulseAnimation) {
      ...
      pulseAnimation.id = "g2-assistant-citation-pulse";

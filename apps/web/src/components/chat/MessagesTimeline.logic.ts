import { worktreeSetupAgentStarted } from "@gentic2/client-runtime/worktree-setup";
export { worktreeSetupAgentStarted } from "@gentic2/client-runtime/worktree-setup";
import * as Equal from "effect/Equal";
import { shallow } from "zustand/vanilla/shallow";
import { renderCodexDirectivesForCopy } from "@gentic2/client-runtime/codex-markdown-directives";
...
export type MessagesTimelineRow =
  ...
  | {
      ...
      summaryToolIcon?: "browser" | "device" | "gentic2" | "pull-request";
      hasFailure: boolean;
    }
  | {
      kind: "turn-fold";

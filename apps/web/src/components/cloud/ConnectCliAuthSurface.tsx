...
import { readConnectAuthorizeRequest } from "@gentic2/shared/connectAuth";
...
const invalidLinkMessage = {
  ...
  description:
    "The link is missing its authorization request. Re-run `g2 connect` in your terminal and open the freshly printed URL.",
} as const;
  ...
  return (
    <AuthSurfaceShell>
      <ConnectCliAuthMessage
        ...
        description={
          isSignedIn
            ? "Redirecting to authorize Gentic2 Connect for your CLI…"
            : "Sign in to continue authorizing Gentic2 Connect for your CLI."
        }
      />
      {isLoaded && !isSignedIn ? (
        <div className="mt-6">

...
import { AuthAdministrativeScopes, AuthRelayWriteScope } from "@gentic2/contracts";
...
/**
 * Post-sign-in onboarding wizard for Gentic2 Connect. Opens on every in-session
 ...
 * account's Gentic2 Connect environments so every device can be connected right
    ...
    <div className="space-y-3">
      <div className="rounded-lg border">
        <OnboardingToggleRow
          ...
          description="Make this environment available to your other devices through Gentic2 Connect."

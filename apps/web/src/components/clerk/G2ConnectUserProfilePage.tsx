...
export function G2ConnectEnvironmentRow(props: {
          ...
          <div className="pt-3">
            ...
            >
              ...
              <p className="mt-4 max-w-xl text-xs leading-4.5 text-muted-foreground">
                Gentic2 Connect access will be revoked, any managed tunnel will be removed, and a
...
export function G2ConnectUserProfilePage() {
  ...
  const handleDeregister = async (environment: RelayClientEnvironmentRecord) => {
    ...
    if (result._tag === "Success") {
      ...
      toastManager.add({
        ...
        description: "Gentic2 Connect access was revoked and a host space is now available.",
      });
      return;
    }
        ...
        {isInitialLoad ? (
          ...
          <div className="border-t">
            <Empty size="compact">
              ...
              <EmptyHeader>
                <EmptyTitle>No Gentic2 Connect environments</EmptyTitle>
                <EmptyDescription>
                  Link an environment from its local Settings to make it available through G2
                  Connect.
                </EmptyDescription>
              </EmptyHeader>
            </Empty>

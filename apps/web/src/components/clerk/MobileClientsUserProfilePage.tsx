import type { RelayClientDeviceRecord } from "@gentic2/contracts/relay";
  ...
  return (
    <Empty size="compact">
      ...
      <EmptyHeader>
        ...
        <EmptyDescription>
          Sign in to Gentic2 on your iPhone to register it for push notifications and Live
          Activities.
        </EmptyDescription>
      </EmptyHeader>
    </Empty>
...
export function MobileClientsUserProfilePage() {
  ...
  return (
    <ClerkUserProfilePage
      ...
      description="Devices registered to receive Gentic2 Connect activity from your environments."
      action={
        <ClerkUserProfileRefreshButton

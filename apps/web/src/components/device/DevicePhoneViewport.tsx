...
import type { PhoneViewer } from "@gentic2/client-runtime/device/phone-viewer";
import type {
  DeviceAccessorySource,
  DeviceModelSource,
} from "@gentic2/client-runtime/device/model";
import type { DeviceShapeProfile } from "@gentic2/client-runtime/device/shape-profile";
...
const loadPhoneViewer = () => import("@gentic2/client-runtime/device/phone-viewer");

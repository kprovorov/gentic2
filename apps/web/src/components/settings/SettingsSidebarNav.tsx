...
const G2ConnectSidebarSignIn = lazy(() =>
  import("../clerk/G2ConnectSidebarSignIn").then((module) => ({
    default: module.G2ConnectSidebarSignIn,
  })),
);
const G2ConnectSidebarAvatar = lazy(() =>
  import("../clerk/G2ConnectSidebarSignIn").then((module) => ({
    default: module.G2ConnectSidebarAvatar,
  })),
);

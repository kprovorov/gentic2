...
import { githubMediaFetchUrl } from "@gentic2/shared/githubMedia";
import {
...
import { inlineCodeFilePathCandidate } from "@gentic2/client-runtime/markdown-links";
import { mediaFileReference, mediaUrlReference } from "@gentic2/client-runtime/media-reference";
import { mediaKindFromPath, mediaMimeTypeFromExtension } from "@gentic2/shared/filePreview";
...
import { parseAssistantCitationHref } from "@gentic2/shared/assistantCitations";
import { parseComposerContextHref } from "@gentic2/shared/composerContextReferences";
...
interface ChatMarkdownProps {
  ...
  /** Renders a `g2-context://` link as a chip; without it the link shows its label as text. */
...
const CHAT_MARKDOWN_SANITIZE_SCHEMA = {
  ...
  protocols: {
    ...
    href: [...(defaultSchema.protocols?.href ?? []), "file", "g2-citation", "g2-context"],
    src: [...(defaultSchema.protocols?.src ?? []), "file", "g2-context"],
  },

...
import { DEFAULT_SERVER_SETTINGS, type ScopedProjectRef, type ThreadId } from "@gentic2/contracts";
...
import { readG2ProjectFile } from "../lib/g2ProjectFileDefaults";
...
export function useNewThreadHandler() {
  ...
  return useCallback(
    (
      ...
      // The shared resolver owns the priority order. The g2.json read is
      ...
      const resolveDefaultEnvMode = async (): Promise<DraftThreadEnvMode> => {
        ...
        const projectFile = consultProjectFile
          ? await readG2ProjectFile(project.environmentId, project.workspaceRoot)
          : null;

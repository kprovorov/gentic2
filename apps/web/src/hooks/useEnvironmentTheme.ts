import type { EnvironmentTheme } from "@gentic2/contracts";
...
function publishedThemeColors(
  ...
  // desktop theme arrives as a coherent Gentic2 palette rather than a foreign
 ...
 * than rendered: a published `g2-iris.json` would show this palette on its

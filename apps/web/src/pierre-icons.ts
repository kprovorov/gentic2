...
import { VIDEO_FILE_EXTENSIONS } from "@gentic2/shared/video";
...
const PIERRE_ICON_SPRITE_ID = "gentic2-pierre-file-icon-sprite";

const G2_FILE_ICON_SPRITE = `
<svg xmlns="http://www.w3.org/2000/svg" width="0" height="0" aria-hidden="true">
  <!-- Lucide Film icon, ISC license. -->
  <symbol id="g2-file-icon-video" viewBox="0 0 24 24">
  ...
  <symbol id="g2-file-icon-agents" viewBox="0 0 32 32">
  ...
  <symbol id="g2-file-icon-pnpm" viewBox="0 0 32 32">
...
export const G2_PIERRE_ICONS = {
  set: "complete",
  colored: true,
  spriteSheet: G2_FILE_ICON_SPRITE,
  byFileName: {
    "package.json": "file-tree-builtin-npm",
    "tsconfig.json": "file-tree-builtin-typescript",
    "agents.md": "g2-file-icon-agents",
    "pnpm-lock.yaml": "g2-file-icon-pnpm",
    "pnpm-workspace.yaml": "g2-file-icon-pnpm",
  },
  byFileExtension: Object.fromEntries(
    VIDEO_FILE_EXTENSIONS.map((extension) => [extension, "g2-file-icon-video"]),
  ),
} satisfies FileTreeIcons;

const completeIconResolver = createFileTreeIconResolver(G2_PIERRE_ICONS);
...
export function ensurePierreIconSprite(): void {
  ...
  container.innerHTML = `${getBuiltInSpriteSheet("complete")}${G2_FILE_ICON_SPRITE}`;

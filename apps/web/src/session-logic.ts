...
} from "@gentic2/client-runtime/pending-requests";
import { UserInputAttachmentAnswerPayload } from "@gentic2/contracts";
import { foldUserInputActivities } from "@gentic2/client-runtime/work-log/user-input";
import * as Option from "effect/Option";
import * as Schema from "effect/Schema";
import * as Arr from "effect/Array";
import { shallow } from "zustand/vanilla/shallow";
import { isBackgroundTaskActivity } from "@gentic2/client-runtime/state/subagentRuntime";
import {
...
import { extractToolActivityPresentation } from "@gentic2/client-runtime/work-log/tool-presentation";
import {
...
export type { PendingApproval, PendingUserInput } from "@gentic2/client-runtime/pending-requests";

export { formatDuration } from "@gentic2/shared/orchestrationTiming";
...
export interface WorkLogEntry {
  ...
  toolTitle?: string;
  toolSurface?: import("@gentic2/contracts").ToolActivitySurface;
  toolIcon?: import("@gentic2/contracts").ToolActivityIcon;
  toolSource?: import("@gentic2/contracts").ToolActivitySource;
  toolData?: unknown;

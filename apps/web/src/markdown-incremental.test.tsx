...
import { remarkCodexDirectives } from "@gentic2/client-runtime/codex-markdown-directives";
...
describe("incremental Markdown parsing", () => {
  it("keeps the document prefix cached when list recovery parses contain fences", () => {
    ...
    expect(parsedSources.some((text) => text.startsWith("g2-markdown-inline-prefix:"))).toBe(true);
  });

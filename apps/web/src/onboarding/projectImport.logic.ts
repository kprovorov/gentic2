import { findProjectByPath } from "@gentic2/client-runtime/state/projects";
import type { AgentSessionProjectCandidate, EnvironmentId, ProjectId } from "@gentic2/contracts";

...
import type { EnvironmentPresentation } from "@gentic2/client-runtime/connection";
import { createEnvironmentPresentationAtoms } from "@gentic2/client-runtime/state/presentation";

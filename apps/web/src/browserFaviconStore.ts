...
import type { DesktopPreviewFavicon, ScopedProjectRef, ScopedThreadRef } from "@gentic2/contracts";
...
const BROWSER_FAVICON_STORAGE_KEY = "gentic2:browser-favicons:v1";

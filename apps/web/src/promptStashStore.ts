import { ComposerContextRecord, ForwardCompatibleArray } from "@gentic2/contracts";
...
export const PROMPT_STASH_STORAGE_KEY = "gentic2:prompt-stash:v2";
/**
 ...
 */
const LEGACY_PROMPT_STASH_STORAGE_KEY = "gentic2:prompt-stash:v1";

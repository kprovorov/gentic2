...
import type { EnvironmentCloudLinkStateResult } from "@gentic2/contracts";
...
export function usePrimaryCloudLinkState() {
  ...
  if (result._tag === "Failure") {
    ...
    error = cause instanceof Error ? cause.message : "Could not read Gentic2 Connect link state.";
  }

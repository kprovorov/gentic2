...
import type { PullRequestMergeMethod } from "@gentic2/contracts";
import { create } from "zustand";
import { normalizeProjectPathForComparison } from "./lib/projectPaths";

export const PERSISTED_STATE_KEY = "gentic2:ui-state:v1";
// Version 1 stored card visibility, not folder expansion.
const THREAD_CHANGED_FILES_EXPANSION_VERSION = 2;
const LEGACY_PERSISTED_STATE_KEYS = [
  "gentic2:renderer-state:v8",
  "gentic2:renderer-state:v7",
  "gentic2:renderer-state:v6",
  "gentic2:renderer-state:v5",
  "gentic2:renderer-state:v4",
  "gentic2:renderer-state:v3",

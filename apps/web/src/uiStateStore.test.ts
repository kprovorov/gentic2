import { ProjectId, ThreadId } from "@gentic2/contracts";
...
describe("uiStateStore pure functions", () => {
  ...
  it("stores the sidebar project scope and resets it to all projects", () => {
    const scoped = setSidebarProjectScopeKey(makeUiState(), "github.com/kprovorov/gentic2");

    expect(scoped.sidebarProjectScopeKey).toBe("github.com/kprovorov/gentic2");
    expect(setSidebarProjectScopeKey(scoped, "github.com/kprovorov/gentic2")).toBe(scoped);
...
describe("uiStateStore persistence", () => {
  ...
  it("restores the sidebar project scope across reloads", () => {
    persistState(makeUiState({ sidebarProjectScopeKey: "github.com/kprovorov/gentic2" }));

...
import { ConnectionTransientError } from "@gentic2/client-runtime/connection";
...
export const CONNECTION_CATALOG_KEY = "gentic2.connection-catalog.v1";
export const LEGACY_CONNECTIONS_KEY = "gentic2.connections";

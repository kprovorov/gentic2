import { PASTED_TEXT_ATTACHMENT_THRESHOLD_BYTES } from "@gentic2/client-runtime/text-paste";
import { PROVIDER_SEND_TURN_MAX_INPUT_CHARS } from "@gentic2/contracts";
import { collectComposerInlineTokens } from "@gentic2/shared/composerInlineTokens";
...
import { resolveMarkdownFileIcon } from "@gentic2/mobile-markdown-text/links";
...
import type { ComposerEditorProps, ComposerEditorSelection } from "./G2ComposerEditor.types";

const NATIVE_MODULE_NAME = "G2ComposerEditor";

...
import type { MediaActionId } from "@gentic2/client-runtime/media-actions";
import type { MediaReference } from "@gentic2/client-runtime/media-reference";
import type { AssetResource, EnvironmentId, ThreadId } from "@gentic2/contracts";

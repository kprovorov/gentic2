...
import { ComposerContextId, EnvironmentId } from "@gentic2/contracts";
...
const clipboard = {
  text: "![Checkout](g2-context://v1/image/image-source) [Build](g2-context://v1/terminal/terminal-source)",

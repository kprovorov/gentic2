...
import { DEFAULT_TERMINAL_ID, type ProjectScript } from "@gentic2/contracts";
import { nextTerminalId, resolveTerminalSessionLabel } from "@gentic2/shared/terminalLabels";

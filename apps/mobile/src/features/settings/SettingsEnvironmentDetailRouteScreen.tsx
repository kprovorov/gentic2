...
import type { EnvironmentId, ServerProvider } from "@gentic2/contracts";
...
function EnvironmentDetail({ environmentId }: { readonly environmentId: EnvironmentId }) {
  ...
  function requestServerUpdate() {
    ...
    Alert.alert(
      ...
      `Install Gentic2 ${targetVersion}. ${capabilities.serverSelfUpdate === "desktop-managed" ? "The desktop app will close and relaunch." : "The server will restart and reconnect."} Running threads may be interrupted.`,
      [
                    ...
                    {!supportsEnvironmentUpdate(config.environment.capabilities) ? (
                      <Text className="text-sm text-foreground-muted">
                        {capabilities?.serverSelfUpdate === "desktop-managed"
                          ...
                          : "Update and restart Gentic2 on this machine."}
                      </Text>
                    ) : null}
                  </View>
                  <SettingsActionRow
                      ...
                      <View key={provider.instanceId}>
                        <View className="gap-1 p-4">
                          <View className="flex-row items-center gap-2">
                            ...
                            <Text className="min-w-0 flex-1 text-base font-g2-medium text-foreground">

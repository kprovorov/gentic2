...
describe("isLegalDocumentUrl", () => {
  it.each([
    "https://gentic2.com/legal",
    "https://gentic2.com/legal/",
    "https://gentic2.com/privacy-policy?source=app",
    "https://gentic2.com/terms-of-service#updates",
    "https://gentic2.com/security-policy",
  ])("allows a configured legal document: %s", (url) => {
    expect(isLegalDocumentUrl(url)).toBe(true);
  });

  it.each([
    "https://gentic2.com/download",

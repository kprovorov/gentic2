...
describe("review comment serialization", () => {
  it("keeps closing-tag text inside a chip label within a real review body", () => {
    const body = "Before [</review_comment>](g2-context://v1/mention/context-1) after";
  ...
  it("treats legacy markup inside a context label as opaque text", () => {
    const text =
      '[<review_comment sectionId="s" filePath="app.ts" startIndex="0" endIndex="0">Review this</review_comment>](g2-context://v1/mention/context-1)';

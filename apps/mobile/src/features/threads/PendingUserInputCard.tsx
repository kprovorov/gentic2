...
import type { ApprovalRequestId, UserInputQuestion } from "@gentic2/contracts";
    ...
    >
      ...
      >
        <View className="flex-1 gap-2.5">
          ...
          <Text className="font-g2-bold text-lg text-foreground">Fill in the pending answers</Text>
        </View>
        ...
        {props.pendingUserInput.questions.map((question) => {
          ...
          return (
            <View key={question.id} className="gap-2 pt-1">
              <Text className="font-g2-bold text-xs uppercase tracking-[1px] text-foreground-muted">
                {question.header}
              </Text>
      ...
      {props.pendingUserInput.dismissible ? (
        ...
        >
          <Text className="font-g2-bold text-sm text-foreground-muted">

...
import { type EnvironmentId, resolveEnvironmentMachineKind } from "@gentic2/contracts";
        ...
        >
          {props.environment.isRelayManaged ? (
            <Text className="text-sm text-foreground-muted">
              Managed by Gentic2 Connect. Tunnel details update automatically.
            </Text>
          ) : (
            <>
              <ConnectionFormField
              ...
              {props.environment.isRelayManaged ? null : (
                ...
                >
                  <SymbolView
                    ...
                    type="monochrome"
                  />
                  <Text className="text-xs font-g2-bold tracking-[0.8px] uppercase text-primary-foreground">
                    Save
                  </Text>
                </Pressable>
              )}

...
import { MarkdownTextPrimitive } from "@gentic2/mobile-markdown-text/primitive";
  ...
  if (props.status === "error") {
    return (
      <View className="border-b border-border bg-card px-4 py-2">
        <Text className="text-2xs font-g2-medium uppercase text-foreground-muted">Plain text</Text>
      </View>
    );
  }
  return null;

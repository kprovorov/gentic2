...
const SHOWCASE_LOCAL_ENVIRONMENT_DISPLAY_URLS: Readonly<Record<string, string>> = {
  ...
  "Suspense Station": "https://suspense-vps.hel1.g2.sh/",
...
const pocketPiEndpoint = {
  httpBaseUrl: "https://pocket-pi.g2.sh",
  wsBaseUrl: "wss://pocket-pi.g2.sh",
  providerKind: "g2_relay" as const,
};
...
export const SHOWCASE_CONNECTED_CLOUD_ENVIRONMENTS: ReadonlyArray<ConnectedEnvironmentSummary> = [
  {
    ...
    displayUrl: "https://aurora-gpu.g2.sh",
    isRelayManaged: true,
    isEnabled: true,

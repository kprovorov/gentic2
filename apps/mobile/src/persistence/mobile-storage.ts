...
const CONNECTIONS_KEY = "gentic2.connections";
const AGENT_AWARENESS_DEVICE_ID_KEY = "gentic2.agent-awareness.device-id";
const AGENT_AWARENESS_REGISTRATION_KEY = "gentic2.agent-awareness.registration";
const RECENT_THREAD_SHORTCUTS_KEY = "gentic2.recent-thread-shortcuts";
...
>()("@gentic2/mobile/persistence/MobileStorage") {}

...
import { EnvironmentNotRegisteredError } from "@gentic2/client-runtime/connection";
import { isTransportConnectionErrorMessage } from "@gentic2/client-runtime/errors";
import { EnvironmentRpcUnavailableError } from "@gentic2/client-runtime/rpc";
import {
  CommandId,
  ComposerContextId,
...
describe("thread outbox", () => {
  it("retains structured context through a persisted offline queue round trip", () => {
    const message: QueuedThreadMessage = {
      ...
      text: "[Build](g2-context://v1/terminal/build-output)",
      context: {
        version: 1,
        records: [
          {

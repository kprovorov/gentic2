import { ProjectId, type ThreadPullRequestLink, type VcsStatusResult } from "@gentic2/contracts";
...
const pullRequest: NonNullable<VcsStatusResult["pr"]> = {
  ...
  url: "https://github.com/kprovorov/gentic2/pull/3774",
  baseRef: "main",
...
describe("resolveThreadPrSource compatibility", () => {
  ...
  const branchRef = { ...legacyRef, number: 2, url: "https://github.com/kprovorov/gentic2/pull/2" };

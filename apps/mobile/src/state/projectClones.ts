...
import { parseScopedProjectKey, scopedProjectKey } from "@gentic2/client-runtime/environment";
import type { EnvironmentId, ProjectCloneSnapshot, ScopedProjectRef } from "@gentic2/contracts";

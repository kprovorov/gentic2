package expo.modules.g2nativecontrols
...
class G2KeyboardCommandsModule : Module() {
  override fun definition() = ModuleDefinition {
    Name("G2KeyboardCommands")

    View(G2KeyboardCommandsView::class) {
      Prop("enabledCommands") { view: G2KeyboardCommandsView, commands: List<String> ->

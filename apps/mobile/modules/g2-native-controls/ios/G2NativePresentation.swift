...
final class G2PresentationSources {
  private class Entry {
...
final class G2PresentationSourceView: ExpoView {
  weak var sources: G2PresentationSources?
  var identifier = "" {
    didSet {
...
final class G2ContextSheetSizeView: ExpoView {
  ...
  private func updateSheet() {
    ...
    while let current = responder {
      if let controller = current as? UIViewController,
        ...
        let identifier = UISheetPresentationController.Detent.Identifier("g2-context-content")

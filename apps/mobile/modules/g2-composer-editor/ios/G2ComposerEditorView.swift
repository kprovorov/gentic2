...
private final class ComposerTextView: UITextView {
  private static let pastedImageDirectoryName = "g2-composer-paste"
  ...
  override func paste(_ sender: Any?) {
    ...
    let pasteboard = UIPasteboard.general
    let context = G2ComposerClipboard.read()
    if !context["fragment", default: ""].isEmpty || context["html", default: ""].contains("data-g2-context-fragment=") {
  ...
  override func copy(_ sender: Any?) {
    ...
    G2ComposerClipboard.write(text: serializedText(in: selectedRange), fragment: clipboardFragment)
  }
...
public final class G2ComposerEditorView: ExpoView, UITextViewDelegate, UITextDropDelegate, UIGestureRecognizerDelegate {
  ...
  private func renderChip(
    ...
    // Kept in step with `G2ContextChipVectorIcon` in the markdown module: a chip drawn here and

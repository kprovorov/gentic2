...
#import "G2MarkdownTextRunComponentDescriptor.h"
...
@interface G2MarkdownTextRun () <RCTT3MarkdownTextRunViewProtocol>

@end

@implementation G2MarkdownTextRun {
  NSString * _text;
...
{
    return concreteComponentDescriptorProvider<G2MarkdownTextRunComponentDescriptor>();
}

- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    static const auto defaultProps = std::make_shared<const G2MarkdownTextRunProps>();
    _props = defaultProps;
  }
  return self;
}
...
{
  const auto &oldViewProps = *std::static_pointer_cast<G2MarkdownTextRunProps const>(_props);
  const auto &newViewProps = *std::static_pointer_cast<G2MarkdownTextRunProps const>(props);
...
- (nullable UIMenu *)contextMenu
{
  ...
  __weak G2MarkdownTextRun *weakSelf = self;
...
- (void)onContextMenuAction:(NSString *)actionIdentifier
{
  if (_eventEmitter != nullptr) {
    std::dynamic_pointer_cast<const facebook::react::G2MarkdownTextRunEventEmitter>(_eventEmitter)
    ->onContextMenuAction(facebook::react::G2MarkdownTextRunEventEmitter::OnContextMenuAction{
...
- (void)onPress {
  if (_eventEmitter != nullptr) {
    std::dynamic_pointer_cast<const facebook::react::G2MarkdownTextRunEventEmitter>(_eventEmitter)
    ->onPress(facebook::react::G2MarkdownTextRunEventEmitter::OnPress{});
  }
}
...
- (void)onLongPress {
  if (_eventEmitter != nullptr) {
    std::dynamic_pointer_cast<const facebook::react::G2MarkdownTextRunEventEmitter>(_eventEmitter)
    ->onLongPress(facebook::react::G2MarkdownTextRunEventEmitter::OnLongPress{});
  }
}
...
Class<RCTComponentViewProtocol> G2MarkdownTextRunCls(void)
{
    return G2MarkdownTextRun.class;
}

...
static NSDictionary *G2ContextChipPayload(NSString *uri)
{
...
static UIColor *G2ContextChipColor(NSString *hex)
{
  unsigned int rgb = 0;
...
static UIColor *G2ContextChipBlend(UIColor *accent, UIColor *base, CGFloat weight)
{
...
static UIImage *G2ContextChipVectorIcon(NSString *symbol, CGFloat size, UIColor *color)
{
...
static inline CGRect G2ContextChipBounds(UIFont *font, CGSize size)
{
...
static inline NSAttributedString *G2MarkdownTextAttachmentString(
...
static UIFont *G2ContextChipFont(NSDictionary *payload)
{
...
static inline CGSize G2ContextChipSize(NSDictionary *payload, CGFloat maximumWidth)
{
  UIFont *font = G2ContextChipFont(payload);
...
static inline UIImage *G2ContextChipImage(NSDictionary *payload, CGSize size, UIImage *fileIcon)
{
  ...
  UIColor *accent = G2ContextChipColor(payload[@"accent"]);
  UIColor *foreground = G2ContextChipBlend(accent, G2ContextChipColor(payload[@"foreground"]), 0.22);
  UIColor *border = G2ContextChipBlend(accent, G2ContextChipColor(payload[@"border"]), 0.34);
  ...
  UIImage *image = [renderer imageWithActions:^(UIGraphicsImageRendererContext *context) {
    ...
    UIImage *icon = fileIcon
        ?: G2ContextChipVectorIcon(payload[@"symbol"], iconSize, foreground)

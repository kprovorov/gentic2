...
const customSprite = webIconSource.match(/const G2_FILE_ICON_SPRITE = `([\s\S]*?)`;/)?.[1];

if (!customSprite) {
  throw new Error("Could not read the G2 Pierre icon sprite from apps/web/src/pierre-icons.ts");
}
...
const customIcons = {
  agents: "g2-file-icon-agents",
  pnpm: "g2-file-icon-pnpm",
  video: "g2-file-icon-video",
};

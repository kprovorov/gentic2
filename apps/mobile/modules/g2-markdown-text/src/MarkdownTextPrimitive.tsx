...
import { setMarkdownSelectionHandleColor } from "./G2MarkdownTextSelectionModule";
import G2MarkdownTextRunNativeComponent from "./G2MarkdownTextRunNativeComponent";
import G2MarkdownTextNativeComponent from "./G2MarkdownTextNativeComponent";
...
function MarkdownTextPrimitiveChild({
  ...
  const nativeChildren = React.Children.toArray(children).map((child) => {
    ...
    return (
      ...
      <G2MarkdownTextRunNativeComponent

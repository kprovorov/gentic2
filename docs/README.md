...
- [Install Gentic2](./user/install.md)
...
- [Updating Gentic2](./user/updating.md)
...
- [Gentic2 Connect](./internals/g2-connect.md)
...
- [Gentic2 Connect setup](./operations/connect-setup.md)

...
Tailscale, SSH, and Gentic2 Connect change how the client reaches that server; they do
...
[Gentic2 Connect trust boundary](./g2-connect.md).
...
connect. This is possible because the desktop renderer is not served by the backend: the `gentic2://`

...
Terms whose meaning matters across Gentic2. Architecture and lifecycle constraints belong in the
...
| Gentic2 home   | The base data directory. Runtime state normally lives under its `userdata` directory.             |
...
| Term                | Meaning                                                                                                      |
| ------------------- | ------------------------------------------------------------------------------------------------------------ |
| Provider            | The agent runtime Gentic2 controls, such as Codex or Claude Code.                                            |
...
| Adapter             | The boundary translating a provider's native protocol into Gentic2 operations and events.                    |
...
| Context reference    | One occurrence of a record in message text: `[label](g2-context://v1/<kind>/<contextId>)`. Several references can share one record. |

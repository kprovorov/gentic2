...
`~/.g2/userdata/keybindings.json` by default. You can edit this file directly.
...
Gentic2 creates the file with its defaults and adds new defaults on later startups.
...
Invalid rules are ignored; if the file cannot be parsed, Gentic2 uses defaults.

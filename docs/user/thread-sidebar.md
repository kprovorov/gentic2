...
When you change a new thread's project, Gentic2 stays in the current environment
...
If dragging is unavailable for one environment, update the Gentic2 server running in that

...
also send files to Gentic2 through another app's system share sheet.
...
messages survive app restarts. Signing out of Gentic2 Connect keeps that work on your
...
Gentic2 remembers your provider, model, and model options for new threads. A
...
Transcription runs on your device. Gentic2 deletes the temporary audio after
...
Provider commands must start the message to run. Gentic2 commands such as
...
complete Gentic2 tells you and leaves the chip for you to remove or replace. A chip whose
...
automatically. HTML previews cannot access your Gentic2 session.

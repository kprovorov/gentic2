...
Both instances must use the same **CODEX_HOME path**. Gentic2 prepares the shared
...
Choose the other account from the thread's model picker. Gentic2 offers compatible
